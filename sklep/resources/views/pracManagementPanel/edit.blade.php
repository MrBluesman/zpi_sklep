            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('pracManagementPanel.update', $user) }}">
                            {{ csrf_field() }}

                            <div class="form-group">
                                <label class="col-md-6 col-md-offset-6">E-mail:</label>
                            ...
                            <div class="form-group">
                                <label class="col-md-6 col-md-offset-6">Dane osobowe:</label>
                            ...
                            <div class="form-group{{ $errors->has('pesel') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    @if(old('pesel')=='')
                                        <input id="pesel" type="text" class="form-control" name="pesel" value="{{ $user->pesel }}" required autofocus>
                                    @else
                            ...
                            <div class="form-group{{ $errors->has('nr_telefonu') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    @if(old('nr_telefonu')=='')
                                        <input id="nr_telefonu" type="text" class="form-control" name="nr_telefonu" value="{{ $user->nr_telefonu }}" required autofocus>
                                    @else
